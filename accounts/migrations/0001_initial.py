    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.JSONField(default=list, help_text='List of image URLs stored in R2', validators=[accounts.models.validate_json_list])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, help_text='Pet image stored in R2', null=True, storage=accounts.storage.R2Storage(), upload_to='pets/')),
                ('features', models.JSONField(default=list, validators=[accounts.models.validate_json_list])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('edited_image', models.ImageField(help_text='The edited image file stored in R2', storage=accounts.storage.R2Storage(), upload_to='edited_pets/')),
